...
1.    Log-in to your account
2.    For now you will see two projects Stage2-FullTextScreening.
...
The SysRev Platform when used for full-text screening is nearly identical to the project for Title/abstract screening. The major difference is as follows:
