...
## Background on SysRev

![](images/SysRev_logo.png){fig-align="center" width=25%}
...
The Data tab will provide a summary of those citations/references and the changes you and your fellow reviewers have made to each in terms of coding (I will explain further).

### Analysis Page

The Analytics tab is closed off to you. Just note that it provides based on your coding and screen activity (It is not pertinent to our screening activity). 
...
<iframe width="85%" height="565" frameborder="0"
...
<iframe width="85%" height="693" frameborder="0"
